...
<!--[Link to original content](https://stat545.com/block028_character-data.html)-->
...
### Character encoding resources
  ...
  * [Strings subsection of data import chapter][r4ds-readr-strings] in R for Data Science
  ...
  * I've translated this blog post [Guide to fixing encoding problems in Ruby](https://www.justinweiss.com/articles/3-steps-to-fix-encoding-problems-in-ruby/) into R as the first step to developing a lesson: [Encoding in R](#character-encoding)

### Character vectors that live in a data frame

  * Certain operations are facilitated by `tidyr`. These are described below.
  * For a general discussion of how to work on variables that live in a data frame, see [Vectors versus tibbles](#vectors-tibbles)
...
For now, this lesson will refer you to other place to read up on this:
  ...
  * The [Strings chapter][r4ds-strings] of [R for Data Science][r4ds].
