...
<!--[Link to original content](https://github.com/STAT545-UBC/STAT545-UBC.github.io/blob/master/block030_date-times.Rmd)--> 
...
[Dates and times][r4ds-dates-times] chapter from [R for Data Science][r4ds] by Hadley Wickham and Garrett Grolemund. See also the subsection on dates and times in the [Data import chapter][r4ds-data-import].
