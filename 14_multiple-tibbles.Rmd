...
<!--[Link to original content](https://stat545.com/block033_working-with-two-tables.html)-->

*Overview of binds, joins, lookups.*

We've covered many topics on how to manipulate and reshape a single data frame:

  * [Basic care and feeding of data in R](#data-care): data frames (and tibbles) are awesome.
  * [Introduction to dplyr](#dplyr-intro): filter, select, the pipe.
  * [dplyr functions for a single dataset](#dplyr-single): single table verbs.
  * [Tidy data using Lord of the Rings][tidydata-lotr]: tidy data, tidyr. *This actually kicks off with a row bind operation, discussed below.*
...
Visit the [dplyr join cheatsheet](#join-cheatsheet) to see concrete examples of all the joins implemented in dplyr, based on comic characters and publishers.
...
See this resource for examples: [Table look up](#lookup).
