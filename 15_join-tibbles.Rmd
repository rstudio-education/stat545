...
```{r include = FALSE}
super_first_table <- function(gt_col1, gt_col2, gt_col3){
  htmltools::withTags(
  table(style = "width: 100%; border: 0px;",
    tr(
      td(style = "width: 38%; vertical-align: top;",
        gt:::as.tags.gt_tbl(gt_col1)
      ),
      td(style = "width: 18%; vertical-align: top;",
        gt:::as.tags.gt_tbl(gt_col2)
      ),
      td(style = "width: 44%; vertical-align: top;",
        gt:::as.tags.gt_tbl(gt_col3)
      )
    )
  )
)
...
pub_first_table <- function(gt_col1, gt_col2, gt_col3){
  htmltools::withTags(
  table(style = "width: 100%; border: 0px;",
    tr(
      td(style = "width: 18%; vertical-align: top;",
...
```{r echo = FALSE}
super_first_table(super_gt, pub_gt, ijsp_gt)
```
...
```{r echo = FALSE}
super_first_table(super_gt, pub_gt, sjsp_gt)
```
...
```{r echo = FALSE}
super_first_table(super_gt, pub_gt, ljsp_gt)
```
...
```{r echo = FALSE}
super_first_table(super_gt, pub_gt, ajsp_gt)
```
...
```{r echo = FALSE}
pub_first_table(pub_gt, super_gt, ijps_gt)
```
...
```{r echo = FALSE}
pub_first_table(pub_gt, super_gt, sjps_gt)
```
...
```{r echo = FALSE}
pub_first_table(pub_gt, super_gt, ljps_gt)
```
...
```{r echo = FALSE}
pub_first_table(pub_gt, super_gt, ajps_gt)
```
...
```{r echo = FALSE}
super_first_table(super_gt, pub_gt, fjsp_gt)
```
