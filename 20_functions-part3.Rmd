...
<!--[Link to original content](https://stat545.com/block011_write-your-own-function-03.html) -->

Writing your own R functions Part 3:`NA` handling, `...`, unit test
...
Hadley Wickham's book [Advanced R][adv-r]
...
Hadley Wickham's [R packages][r-pkgs] book

  * [Testing chapter][r-pkgs-tests]
  
Article [testthat: Get Started with Testing][testthat-article] in The R Journal Vol. 3/1, June 2011. Maybe this is completely superseded by the newer chapter above? Be aware that parts could be out of date, but I recall it was a helpful read.
