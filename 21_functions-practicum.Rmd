...
<!--[Link to original content](https://stat545.com/block012_function-regress-lifeexp-on-year.html)-->

Function-writing Practicum: fit a linear model and return estimated coefficients
...
<!--section linked to above is under the deprecated section in the appendix-->
