...
<!--[Link to original content](https://stat545.com/block015_graph-dos-donts.html)-->

<!-- Link below is broken and I can't find the source material.
...
*CMEG = Naomi Robbins' book ["Creating More Effective Graphs"][robbins-effective-graphs]; visual catalog of figures via the [R Graph Catalog][r-graph-catalog-github]*
...
Tufte, as quoted by Robbins: "the only worse design than a pie chart is several of them."
  ...
  * "Problem 2: pie charts are worse at showing trends" from [Three reasons that pie charts suck][why-pi-charts-suck] shows a series of 3 pie charts versus a line chart.
...
* ["Creating More Effective Graphs"][robbins-effective-graphs] by [Naomi Robbins][naomi-robbins]  
...
* [Winston Chang's][winston-chang-github] book ["R Graphics Cookbook"][r-graphics-cookbook] and the [Graphs section][cookbook-for-r-graphs] of his [Cookbook for R website][cookbook-for-r]  
* My [`ggplot2` tutorial][ggplot2-tutorial]  
* "Let's Practice What We Preach: Turning Tables into Graphs" by Gelman A, Pasarica C, Dodhia R. *The American Statistician*, Volume 56, Number 2, 1 May 2002 , pp. 121-130(10). via [JSTOR](https://www.jstor.org/stable/3087382?seq=1#page_scan_tab_contents)  
