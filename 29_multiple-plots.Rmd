...
<!--[Link to original content](http://stat545.com/block020_multiple-plots-on-a-page.html)-->
...
In his [Cookbook for R][cookbook-for-r], Winston Chang uses the `grid` package to define the `multiplot()` function:
...
The `cowplot` package (on [CRAN][cowplot-cran], on [GitHub][cowplot-github]) does (at least) two things:
