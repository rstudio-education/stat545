...
* [R Packages][r-pkgs2] by Hadley Wickham and Jenny Bryan [-@wickham-unpub]. The above lessons follow it and the [`devtools`][devtools-web] package workflow quite faithfully (`devtools` on [CRAN][devtools-cran], on [GitHub][devtools-github]).
