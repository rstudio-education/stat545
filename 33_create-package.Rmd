...
<!--Has this section been edited? There are some parts that deviate from the original stat545 material-->

This section closely tracks with content from the book R Packages
[r-pkgs2] (currently a work in progress, see [here][r-pkgs2] for the 1st edition) by Hadley Wickham and Jenny Bryan, specifically the chapter ["The Whole Game."][r-pkgs2-whole-game] The material in this chapter is, however, accurate and up-to-date, although a bit longer than ["The Whole Game."][r-pkgs2-whole-game] The [R Packages][r-pkgs2] book is a great place to go next to learn more. 
