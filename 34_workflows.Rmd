...
* Karl Broman covers GNU Make in his course [Tools for Reproducible Research](https://kbroman.org/Tools4RR/pages/schedule.html) *(see first week)*
...
See slides [here](http://stat545.com/automation01_slides/index.html#/automating-data-analysis-pipelines)
...
## Run `make` from the [shell][hg-shell]
