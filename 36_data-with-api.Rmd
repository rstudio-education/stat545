...
```{r}
download.file(response_parsed$Poster, destfile = "img/harry-potter-poster.jpg")
```

Here it is!
![](img/harry-potter-poster.jgp)

If you want to keep going why don't you try getting the movie posters for the next Harry Potter film in the series, Harry Potter and Prisoner of Azkaban (2004)? Once you do that try writing a function that will get the movie posters for all of the films in the Harry Potter series.
