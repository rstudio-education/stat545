...
```{r include = FALSE}
source("common.R")
Sys.setenv(OMDB_API_KEY = "<your-secret-key>") 
```
...
We can use this to easily add our API key to the request URL.
...
```{r real-xml-req, echo = FALSE, warning = FALSE}
request_xml <- omdb(title = "Interstellar", year = "2014", plot = "short", 
                    format = "xml", api_key = Sys.getenv("OMDB_API_KEY_REAL"))
...
```{r real-json-req, echo = FALSE, warning = FALSE}
request_json <- omdb(title = "Interstellar", year = "2014", plot = "short", 
                     format = "json", api_key = Sys.getenv("OMDB_API_KEY_REAL"))
...
the_martian <- GET("http://www.omdbapi.com/?", 
                   query = list(t = "The Martian", y = 2015, plot = "short", 
                                r = "json", apikey = Sys.getenv("OMDB_API_KEY_REAL")))
content(the_martian)
```
