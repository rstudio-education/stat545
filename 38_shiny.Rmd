...
* [leaflet][leaflet] - Add interactive maps to your apps (on [CRAN](https://cloud.r-project.org/package=leaflet); on [GitHub](https://github.com/rstudio/leaflet)).
...
- [Lots of short useful articles about different topics in Shiny](https://shiny.rstudio.com/articles/) - **highly recommended**
