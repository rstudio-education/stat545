...
<!--[Link to original content rendered](http://stat545.com/bit007_draw-the-rest-of-the-owl.html)-->
<!--[Link to original content raw](https://github.com/STAT545-UBC/STAT545-UBC.github.io/blob/master/bit007_draw-the-rest-of-the-owl.Rmd)-->
...
My reference is the section of Wickham's [Advanced R][adv-r] that is about [closures][adv-r-closures], "functions written by functions". Here's one of the two main examples: a function that creates an exponentiation function.
...
<!--[Link to original content rendered](http://stat545.com/bit006_github-browsability-wins.html)-->
<!--[Link to original content raw](https://github.com/STAT545-UBC/STAT545-UBC.github.io/blob/master/bit006_github-browsability-wins.Rmd)-->
...
## sheet for `dplyr` join functions
